...
- Mundo: `world.js` (chunks 16×16×128, generación con "column specs" compartidos por el mundo normal y los presets, `buildTree` con roble/abedul/abeto/palmera/gigante/seco, mapa de orientación `facing` y block entities para cofres y hornos) · `presets.js` (mundos temáticos que se activan con palabras en la semilla).
...
- Posibles mejoras: generación y mallado en Web Workers, líquidos que fluyen, puertas y escaleras, encantamientos, clima (lluvia/nieve), multijugador.
